...
#if defined(NDEBUG)
# error "RideMyCarCoin cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAgeAdjusted = 60 * 60 * 24;  	// 1 Hour after block 10000
...
const string strMessageMagic = "RideMyCarCoin Signed Message:\n";
...
{
    RenameThread("ridemycarcoin-loadblk");
